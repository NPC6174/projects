#
# Weekday Count Challenge
# Write a program that counts the number of a certain weekday in the month and year that the user enters
#
...
while(run):
    try:
        print("Which of the week do you want to count?")
        print("0: Monday")
        print("1: Tuesday")
        print("2: Wednesday")
        print("3: Thursday")
        ...
        print("There are " + str(result) + " or those days in the month and year specified")
        print("-----------\n")
